...
// mesma função de cima ==== Outra forma de ser realizada sem a necessidade de criar uma nova função.
...
/* 
o filter foi usado dentro de uma função que recebe dois parâmetros, o array de valores e uma string, o que será removido. A condição de dentro do filter é para retornar sempre que o elemento for diferente do name passado.  */